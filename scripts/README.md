...
| [Moonbounce](https://moonbounce.gg/) | [Install](https://github.com/Jordy3D/MoonbouncePlus/raw/main/scripts/MoonbouncePlus.user.js) | At the moment, simply stores a list of items and recipes internally, and allows for the easy copying of that information to the clipboard. More to come! |
